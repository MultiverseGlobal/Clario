...
export const ECOSYSTEM_APPS = [
  {
    ...
    url: (import.meta as any).env?.VITE_PSEUDONYMS_ID_URL || 'http://localhost:3005',
  ...
  },
  {
    ...
    url: (import.meta as any).env?.VITE_CLARIO_URL || 'https://clariovid.vercel.app',
  ...
  },
  {
    ...
    url: (import.meta as any).env?.VITE_ATLAS_URL || 'https://atlas-scale.vercel.app',
    status: 'live' as const,
    Icon: AtlasIcon,
  },
  {
    ...
    url: (import.meta as any).env?.VITE_METAPHOR_URL || 'https://metaphor-backend.onrender.com',
    status: 'live' as const,
    Icon: MetaphorIcon,
  },
  {
    ...
    url: (import.meta as any).env?.VITE_ORION_URL || 'exp://localhost:8081',
  ...
  },
  {
    ...
    url: (import.meta as any).env?.VITE_WEAVE_URL || 'http://localhost:3000/weave',
    status: 'live' as const,
    Icon: WeaveIcon,
  },
];
